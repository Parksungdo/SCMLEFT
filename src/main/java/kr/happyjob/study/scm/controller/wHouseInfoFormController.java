...
public class wHouseInfoFormController {
	...
	public Map<String, Object> WhListVue(Model model, @RequestParam Map<String, Object> paramMap,
		...
		List<WarehouseVO> WhResponsList = wHouseInfoFormService.WhResponsList(paramMap);
		...
		resultMap.put("WhResponsList", WhResponsList);
	...
	@ResponseBody
	public Map<String, Object> detailWh(Model model, @RequestParam Map<String, Object> paramMap,
			HttpServletRequest request, HttpServletResponse response, HttpSession sess) throws Exception {
