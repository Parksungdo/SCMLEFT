...
public class wHouseInfoFormServiceImpl implements wHouseInfoFormService {
	...
	@Override
	public List<WarehouseVO> WhResponsList(Map<String, Object> paramMap) throws Exception {
		
		List <WarehouseVO> WhResponsList = wHouseInfoFormDao.WhResponsList(paramMap);
		return WhResponsList;
	}
