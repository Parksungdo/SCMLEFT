					  ...
					  view:function(no){
						  ...
						  var param = { 
					       ...
					       var callafterback = function(data) { 
						    	  ...
						    	  console.log(parseInt(data.pageNum));

						    	  
						    	  tablelist.listitem = data.newOrder;
						    	  tablelist.pagenavi = getPaginationHtml(currentPage, data.orderCount, pageSize, pageBlock, 'tablelist.view'); 
								  };
									...
									<tbody id = "orderStatusTBody" v-for="(item,index) in listitem"
													...
													<tr>
														...
														<td>
                                                               ...
                                                               <templete v-else>
                                                                   <div style="color: red;font-weight: bold;" @click="upjord(item.jordNo)">입금하기</div>
                                                               </templete>	
														</td>
													</tr>
									</tbody>
