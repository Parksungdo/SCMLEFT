	...
	function fn_noticereg() {
	 ...
	 function fn_noticesave() {
		 ...
		 var savecallback = function(savereturn) {
			 ...
			 if(savereturn.resultMsg == "SUCCESS" || savereturn.resultMsg == "UPDATED") {
				 alert("저장 되었습니다.");
				 gfCloseModal();
	 ...
	 function fn_noticedelete() {
		 var param = {
			 ...
			 callAjax("/system/noticeDelete.do", "post", "json", true, param, savecallback);
	 ...
	 function inputkey(event) {
		...
		function fSelectGrpCod(grp_cod) {
			...
			var resultCallback = function(data) {
				console.log("fSelectGrpCod : " + JSON.stringify(data));
					...
					<div class="content" style="margin-bottom:20px;">
                        ...
                        <div id="vuevar">
		                    ...
		                    <table width="100%" class="col" border=0>
					        	...
					        	<p class="conTitle">
							       <span>공지사항</span> <span class="fr"> <a
								         class="btnType blue" href="javascript:fn_noticereg();" name="modal"><span>신규등록</span></a>
							      </span>
						       </p>					        							     
		...
		<dl>
			...
			<dd class="content">
				...
				<div class="btn_areaC mt30">
				    ...
				    <a href=""	class="btnType red"  id="btndelete" name="btn" v-show="delflag"><span>삭제</span></a>
